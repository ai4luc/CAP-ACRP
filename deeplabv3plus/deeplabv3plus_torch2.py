...
# ------------- Applying -------------
cerradatav3 = '/Users/mateus.miranda/INPE-CAP/MSc/ai4luc/data/cerradatav3_1_DA/train/'

# Training CBERS4A RGB
if __name__ == '__main__':
    main(epochs=EPOCHS, batch_size=BATCH_SIZE, num_classes=NUM_CLASSES, path=cerradatav3,
         dir_report=exp_directory, num_channels=4, name_dataset='cerradatav3_comDA_')
